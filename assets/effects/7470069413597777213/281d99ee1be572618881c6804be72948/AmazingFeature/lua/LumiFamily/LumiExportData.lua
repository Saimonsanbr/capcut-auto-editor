...
local ae_durations = {
    ['LumiAnimSeqLoadAndCrop_30-effect0'] = {
        ...
        ['texDuration'] = {
            ['InputTex'] = {{0, 3}, },
            ['seqTex_1_1'] = {{0, 15.0666666666667}, },
            ['seqTex_9_16'] = {{0, 15.0666666666667}, },
            ['seqTex_16_9'] = {{0, 15.0666666666667}, },
            ['seqTex_5.8'] = {{0, 15.0666666666667}, },
            ['seqTex_2_1'] = {{0, 15.0666666666667}, },
            ['seqTex_3_4'] = {{0, 15.0666666666667}, },
            ['seqTex_4_3'] = {{0, 15.0666666666667}, },
            ['seqTex_1.85_1'] = {{0, 15.0666666666667}, },
            ['seqTex_2.35_1'] = {{0, 15.0666666666667}, },
        },
    },
    ['LumiVignette_25-effect0'] = {
        ['nodeDuration'] = {{0, 3}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3}, },
        },
    },
    ['LumiTemperatureTone_25-effect1'] = {
        ['nodeDuration'] = {{0, 3}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3}, },
        },
...
local ae_attribute = {
    ...
    ['LumiVignette_25-effect0'] = {
        ...
        ['amount'] = 0.38,
        ['midpoint'] = 0.5,
        ['roundness'] = -0.20000000298023,
        ['feather'] = 0.5,
        ['highlight'] = 0,
        ['transparent'] = false,
    },
    ['LumiTemperatureTone_25-effect1'] = {
        ['temperatureIntensity'] = 0.82,
        ['toneIntensity'] = 0.5,
    },
    ['LumiLayer_30-blend'] = {
        ['hasBlend'] = true,
...
local ae_sliderInfos = {
    ['effects_adjust_intensity'] = {
        {'LumiVignette_25-effect0', 'amount', 'number', {true, }, 1, 2, 0, 1, {0, }, {0, }, },
    },
    ['effects_adjust_color'] = {
        {'LumiTemperatureTone_25-effect1', 'temperatureIntensity', 'number', {true, }, 1, 2, 0, 1, {0, }, {0, }, },
    },
}
